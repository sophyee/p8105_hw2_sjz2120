...
The resulting merged dataset `pols_snp_unemploy_df` contains a total of
**828 rows/observations** and **11 columns/variables**. Key variables in
the cleaned/tidied `pols_snp_unemploy_df` dataset include: **year,

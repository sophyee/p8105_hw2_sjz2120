...
Key variables for the both_trash_data joined dataframe include: **`r colnames(both_trash_data)`**. All of these variables with the exception of `mr_prof` were from the original datasets. All of these variables were numeric types (specifically, doubles) with the exception of:
